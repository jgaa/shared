...
Dialog {
    ...
    ColumnLayout {
        ...
        Label {
            text: "Solid lines are direct connections observed locally. Gold dotted lines are peers reachable from this node through relays. Blue dotted lines are peer-to-peer links reported by currently connected peers."
        ...
        Rectangle {
            ...
            ScrollView {
                ...
                Item {
                    id: graph_content
                    width: app_controller.stitched_graph_width
                    height: app_controller.stitched_graph_height
                    ...
                    Repeater {
                        model: app_controller.stitched_graph_nodes
            ...
            Label {
                anchors.centerIn: parent
                visible: app_controller.stitched_graph_nodes.length === 0
                text: "No topology snapshot is available yet."
                color: palette.mid
                font.pixelSize: 12
            }
        }
